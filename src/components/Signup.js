    ...
    validation_form(name, value){
        ...
        if (name === 'fname' || name === 'lname') {
            ...
            if (value.length < 5) {
               ...
               {name === 'fname'? this.setState({firstName: value}) :this.setState({Lastname: value})}
                return true
            }
        }
        if (name === 'password') {
            let regexp = new RegExp('^(?=.*[A-Za-z])[A-Za-z\d]{8,}$')
    ...
    render() {
        return (
            <>
              ...
              <Typography component="h1" variant="h5" style={{position: "relative", top: "10px"}}>
                    Sign up
                </Typography>
                </Grid>
                <Grid container spacing={2} style={{ marginTop: "50px", display: "flex", justifyContent: "center" }}>
                <Grid item>
                   ...
                   <span style={{color: "red", fontSize: "12px"}}>{this.state.errors.fname}</span>
                    <Grid item>
                        ...
                        />
                         ...
                         <span style={{color: "red", fontSize: "12px"}}>{this.state.errors.lname}</span>
                        </Grid>
                        ...
                        <p style={{marginLeft: "75px"}}>Already have an account <a href="#">Sign in</a></p>
                        <Grid container style={{ marginTop: "20px", display: "flex", justifyContent: "center" }}>
                        <Button variant="contained" onClick={(e)=> this.submit(e)}>Sign up</Button>
                        </Grid>
                        </Box>
            </>
